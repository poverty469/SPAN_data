...
def getClassBreaks(data, numberOfClasses):
    ...
    for breakModeName in classBreakModeNames:
        ...
        renderer = qgis.core.QgsGraduatedSymbolRenderer.createRenderer(layer, fieldName, numberOfClasses, mode, symbol, colorRamp)
...
for field in fields:
    ...
    if (fieldName != ID_FIELD_NAME):
        ...
        layerSummary[ID_FIELD_NAME + "s"] = getFieldData(layer, fieldName)
